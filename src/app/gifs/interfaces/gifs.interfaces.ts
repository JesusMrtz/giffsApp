...
const typeMap: any = {
  ...
  Images: o([
      ...
      { json: 'downsized', js: 'downsized', typ: r('The480WStill') },
      { json: 'downsized_large', js: 'downsized_large', typ: r('The480WStill') },
      { json: 'downsized_medium', js: 'downsized_medium', typ: r('The480WStill') },
      { json: 'downsized_small', js: 'downsized_small', typ: r('DownsizedSmall') },
      { json: 'downsized_still', js: 'downsized_still', typ: r('The480WStill') },
      ...
      { json: 'fixed_height_small_still', js: 'fixed_height_small_still', typ: r('The480WStill') },
      { json: 'fixed_height_still', js: 'fixed_height_still', typ: r('The480WStill') },
      ...
      { json: 'fixed_width_small_still', js: 'fixed_width_small_still', typ: r('The480WStill') },
      { json: 'fixed_width_still', js: 'fixed_width_still', typ: r('The480WStill') },
      { json: 'looping', js: 'looping', typ: r('Looping') },
      { json: 'original_still', js: 'original_still', typ: r('The480WStill') },
      { json: 'original_mp4', js: 'original_mp4', typ: r('DownsizedSmall') },
      { json: 'preview', js: 'preview', typ: r('DownsizedSmall') },
      { json: 'preview_gif', js: 'preview_gif', typ: r('The480WStill') },
      { json: 'preview_webp', js: 'preview_webp', typ: r('The480WStill') },
      { json: '480w_still', js: '480w_still', typ: r('The480WStill') },
  ], false),
  The480WStill: o([
